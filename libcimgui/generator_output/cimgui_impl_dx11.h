...
IMGUI_IMPL_API
CIMGUI_API void cImGui_ImplDX11_Shutdown(void);
IMGUI_IMPL_API
CIMGUI_API void cImGui_ImplDX11_NewFrame(void);
IMGUI_IMPL_API
CIMGUI_API void cImGui_ImplDX11_RenderDrawData(ImDrawData* draw_data);

// Use if you want to reset your rendering device without losing Dear ImGui state.
IMGUI_IMPL_API
CIMGUI_API void cImGui_ImplDX11_InvalidateDeviceObjects(void);
IMGUI_IMPL_API
CIMGUI_API bool cImGui_ImplDX11_CreateDeviceObjects(void);
